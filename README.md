...
Automating development workflows to accelerate release cycle. Using Github Actions to automate testing, building and deploying their applications to an existing Kubernetes cluster.
